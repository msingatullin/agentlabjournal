...
Методика в `methods/content-workflow.md` является рабочей инструкцией. Примеры и транскрипции используются только для извлечения структуры, а не как текст для переписывания.
